Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/Firework-Firework"
{
    Properties
    {
...
#define PROP_MAINFADETYPE 0
#define PROP_MAINMINALPHA 0
#define PROP_MAINMAXALPHA 0.938
...
#define PROP_ANGLETYPE 2
#define PROP_ANGLECOMPARETO 1
#define PROP_CAMERAANGLEMIN 53.7
