Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/7d95976f790cd3c459a40bef59025f36"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTexture_ST = float4(5,2,0,0);
				...
				Decal0.m_DecalBlendAlpha = (0.414 /*_DecalBlendAlpha*/);
				...
				Decal0.m_DecalDepth = (-0.07 /*_Decal0Depth*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6646907,0.6646907,1,0.572549).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.6646907,0.6646907,1,0.572549).a;
