Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/1882f9bff9bbbbc419177cc5a1111726"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalColor = float4(0.9649543,1,0.4125678,1);
				...
				Decal1.m_DecalColor = float4(0.9726528,1,0.2458856,1);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.9419067,1,0.4386417,0.8588235).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.9419067,1,0.4386417,0.8588235).a;
