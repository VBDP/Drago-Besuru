    ...
    float3 randomFloat3WiggleRange(float2 Seed, float Range)
    {
        ...
        float speed = 1 + (15.0 /*_GlitterSpeed*/);
    ...
    {
        float2 st = frac(poiMesh.uv[0] + float4(0,0,0,0).xy * _Time.x) * (500.0 /*_GlitterFrequency*/);
        ...
        switch((0.0 /*_GlitterMode*/))
        {
            ...
            float brightness = sin((_Time.x + offset) * (15.0 /*_GlitterSpeed*/)) * (20.0 /*_glitterFrequencyLinearEmissive*/) - ((20.0 /*_glitterFrequencyLinearEmissive*/) - 1);
        ...
        glitterColor *= lerp(1, albedo, (0.0 /*_GlitterUseSurfaceColor*/));
        #if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
