    ...
    void ApplyPositionText(inout float4 albedo, float2 uv)
    {
        ...
        uv = TransformUV(float4(-0.13,0.065,0,0), (180.0 /*_TextPositionRotation*/), float4(0.6,0.1,1,1), uv);
        ...
        albedo.rgb = lerp(albedo.rgb, float4(0.06124606,0.5972019,0.07618538,1).rgb, opacity * float4(0.06124606,0.5972019,0.07618538,1).a);
        globalTextEmission += float4(0.06124606,0.5972019,0.07618538,1).rgb * opacity * (0.5 /*_TextPositionEmissionStrength*/);
    }
    void ApplyTimeText(inout float4 albedo, float2 uv)
    {
        ...
        uv = TransformUV(float4(-0.14,0.31,0,0), (180.0 /*_TextTimeRotation*/), float4(0.6,0.1,1,1), uv);
        if(uv.x > 1 || uv.x < 0 || uv.y > 1 || uv.y < 0)
        {
            return;
        }
        ...
        float opacity = clamp(sigDist + 0.5, 0, 1);
        albedo.rgb = lerp(albedo.rgb, float4(0.06124606,0.5972019,0.07618538,1).rgb, opacity * float4(0.06124606,0.5972019,0.07618538,1).a);
        globalTextEmission += float4(0.06124606,0.5972019,0.07618538,1).rgb * opacity * (0.5 /*_TextTimeEmissionStrength*/);
    }
    void ApplyFPSText(inout float4 albedo, float2 uv)
    {
        ...
        uv = TransformUV(float4(-0.14,-0.17,0,0), (180.0 /*_TextFPSRotation*/), float4(0.6,0.1,1,1), uv);
        if(uv.x > 1 || uv.x < 0 || uv.y > 1 || uv.y < 0)
        {
            return;
        }
        ...
        float opacity = clamp(sigDist + 0.5, 0, 1);
        albedo.rgb = lerp(albedo.rgb, float4(0.06124606,0.5972019,0.07618538,1).rgb, opacity * float4(0.06124606,0.5972019,0.07618538,1).a);
        globalTextEmission += float4(0.06124606,0.5972019,0.07618538,1).rgb * opacity * (0.5 /*_TextFPSEmissionStrength*/);
    }
    void ApplyTextOverlayColor(inout float4 albedo, inout float3 textOverlayEmission)
    {
        ...
        half positionalOpacity = 0;
            ...
            if((1.0 /*_TextFPSEnabled*/))
            {
                ApplyFPSText(albedo, poiMesh.uv[(0.0 /*_TextFPSUV*/)]);
            }
            
            if((1.0 /*_TextPositionEnabled*/))
            {
                ApplyPositionText(albedo, poiMesh.uv[(0.0 /*_TextPositionUV*/)]);
            }
            
            if((1.0 /*_TextTimeEnabled*/))
            {
                ApplyTimeText(albedo, poiMesh.uv[(0.0 /*_TextTimeUV*/)]);
            }
