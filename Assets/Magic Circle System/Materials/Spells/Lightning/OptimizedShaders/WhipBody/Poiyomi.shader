Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/fb8eeffe273633242988864a5e6b11bf"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTexture_ST = float4(-5.35,0.35,0,-0.62);
				Decal0.m_DecalTexturePan = float4(100,0,0,0);
				Decal0.m_DecalTextureUV = (0.0 /*_DecalTextureUV*/);
				Decal0.m_DecalColor = float4(0.5225216,0.5230561,1,1);
				Decal0.m_DecalColorThemeIndex = (0.0 /*_DecalColorThemeIndex*/);
				Decal0.m_DecalTiled = (0.0 /*_DecalTiled*/);
				Decal0.m_DecalBlendType = (6.0 /*_DecalBlendType*/);
				...
				Decal1.m_DecalTexture_ST = float4(4.95,0.29,0,-0.55);
				Decal1.m_DecalTexturePan = float4(-50,0,0,0);
				Decal1.m_DecalTextureUV = (0.0 /*_DecalTexture1UV*/);
				Decal1.m_DecalColor = float4(0.5225216,0.5230561,1,1);
				...
				Decal2.m_DecalTexture_ST = float4(3.94,0.35,0,-0.62);
				Decal2.m_DecalTexturePan = float4(50,0,0,0);
				Decal2.m_DecalTextureUV = (0.0 /*_DecalTexture2UV*/);
				Decal2.m_DecalColor = float4(0.5225216,0.5230561,1,1);
				Decal2.m_DecalColorThemeIndex = (0.0 /*_DecalColor2ThemeIndex*/);
				Decal2.m_DecalTiled = (0.0 /*_DecalTiled2*/);
				Decal2.m_DecalBlendType = (6.0 /*_DecalBlendType2*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveDetailNoiseUV*/)], float4(21,1,0,0)), float4(0,0,0,0));
				#else
				...
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0,0,0,0).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0,0,0,0).a);
					#ifndef POI_SHADOW
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, poiUV(mainUV, float4(5.35,0.35,1,-0.69)), float4(-200,0,0,0), (0.0 /*_MainTexStochastic*/));
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5552226,0.5373389,1,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.5552226,0.5373389,1,1).a;
