...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
	...
	#endif
	float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, TRANSFORM_TEX(poiMesh.uv[float(0)], _MainTex) + _Time.x * float4(0.8,0.8,0,0));
	half3 detailMask = 1;
	...
	**********************************************************************/
	finalEmission += finalColorBeforeLighting.rgb * float(10) * albedo.a;
