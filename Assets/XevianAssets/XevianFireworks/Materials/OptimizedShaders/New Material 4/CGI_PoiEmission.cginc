...
float3 calculateEmissionNew(in float3 baseColor, inout float4 finalColor)
{
    ...
    float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (1.0 /*_GITDEMinEmissionMultiplier*/), (0.0 /*_GITDEMaxEmissionMultiplier*/), (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/));
        ...
        {
            emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(0,0,0,0)).rgb * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(5.992157,5.992157,0,1).rgb;
        }
        else
        {
            emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(5.992157,5.992157,0,1).rgb;
        }
    #else
        emissionColor0 = lerp(1, baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(5.992157,5.992157,0,1).rgb;
    #endif
    ...
    finalColor.rgb = lerp(finalColor.rgb, saturate(emissionColor0 + emissionColor1), saturate(emissionStrength0 + emissionStrength1) * (1.0 /*_EmissionReplace*/) * poiMax(emission0 + emission1));
